...
import connectDB, { squel } from '../../../db';
...
describe('/api/v1/users', () => {
  ...
  before(async () => {
    ...
    await connectDB(dbClient => dbClient.query(squel.remove().from('"Users"').toParam()));
  });
  ...
  it('should create user', async () => {
    ...
    expect(newUser).to.be.an('object').with.keys('id', 'firstName', 'lastName', 'email', 'skills');
  ...
  it('should get users', async () => {
    ...
    users.forEach(u =>
      expect(u).to.be.an('object').with.keys('id', 'firstName', 'lastName', 'email', 'skills'));
  });
  ...
  it('should get user', async () => {
    ...
    expect(getUser).to.be.an('object').with.keys('id', 'firstName', 'lastName', 'email', 'skills');
  ...
  it('should patch user', async () => {
    ...
    expect(patchedUser).to.be.an('object').with.keys('id', 'firstName', 'lastName', 'email', 'skills');
